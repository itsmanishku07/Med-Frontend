  ...
  return (
    <div className="min-h-screen pt-16 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary-400 rounded-full mix-blend-multiply filter blur-[128px] opacity-40 animate-pulse-slow"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-secondary-400 rounded-full mix-blend-multiply filter blur-[128px] opacity-40 animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
      </div>

      <div className="max-w-md w-full z-10 animate-fade-in-up">
        <div className="bg-white/80 backdrop-blur-xl p-10 rounded-3xl shadow-glass border border-white/60">
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white/80 text-gray-500 font-medium rounded-full">Or continue with email</span>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      type="email"
                      className={`w-full pl-11 pr-4 py-3.5 bg-white/50 border rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent focus:bg-white transition-all duration-300 outline-none ${errors.email ? 'border-red-400' : 'border-gray-200 hover:border-gray-300'}`}
                      placeholder="you@example.com"
                    />
                  </div>
                  {errors.email && (
                    <p className="mt-1.5 text-sm text-red-500 ml-1 font-medium">{errors.email.message}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      className={`w-full pl-11 pr-12 py-3.5 bg-white/50 border rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-transparent focus:bg-white transition-all duration-300 outline-none ${errors.password ? 'border-red-400' : 'border-gray-200 hover:border-gray-300'}`}
                  ...
                  {errors.password && (
                    <p className="mt-1.5 text-sm text-red-500 ml-1 font-medium">{errors.password.message}</p>
                  )}
                </div>
              </div>
